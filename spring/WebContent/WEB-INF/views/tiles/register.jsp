...
<sf:form method="post" modelAttribute="student" enctype="multipart/form-data" >
	...
	<label for="stu_age">年龄：</label><sf:input path="age" id="stu_age"  /><sf:errors path="age" /><br/><br/>
	...
	<label for="stu_name2">里面的姓名：</label><sf:input path="stu.name" id="stu_name" /><sf:errors path="stu.name" /><br/>
