...
<title>My JSP 'magnifier.jsp' starting page</title>
...
.large {
	...
	background: url('files/disAllowed.jpg')
		no-repeat;
...
<script type="text/javascript">
	$(document).ready(
			function() {
				...
				$(".large").css("background"," url('files/disAllowed.jpg') no-repeat");
				var native_width = 0;
				var native_height = 0;
...
<body>
	...
	<div class="magnify">
		...
		<img class="small" src="files/disAllowed.jpg" width="200" />
