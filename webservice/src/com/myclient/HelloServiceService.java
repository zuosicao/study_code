 ...
 * 
 */
@WebServiceClient(name = "HelloServiceService", targetNamespace = "http://myservices.com/", wsdlLocation = "http://localhost:8080/helloService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICESERVICE_QNAME = new QName("http://myservices.com/", "HelloServiceService");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://myservices.com/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservices.com/", "HelloServicePort"), HelloService.class, features);
    }
